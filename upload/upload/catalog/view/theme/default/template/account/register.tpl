      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset id="address">     
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
                <div class="col-sm-5 registerPageMap" id="map"></div>
            </div>
          </div>
          <div class="form-group">
...
function renderCurrentLocation(){
 ...
 function initMap(la,lo) {
     // alert("map id "+ document.getElementById('map')+"lat"+la+"lo"+lo)
 ...
 // document.getElementById('submit').addEventListener('click', function() {
    geocodeLatLng(geocoder, map, infowindow,la,lo);
 // });
}
...
function geocodeLatLng(geocoder, map, infowindow,lat,long) {
  ...
  geocoder.geocode({'location': latlng}, function(results, status) {
   console.log("final address", results[0])
    if (status === 'OK') {
        
            document.getElementById("input-address-1").value=results[0].formatted_address;
            //  document.getElementById("input-location").value=results[0].formatted_address;
            
            // document.getElementById("input-sku").value= lat
            // document.getElementById("input-upc").value=long
